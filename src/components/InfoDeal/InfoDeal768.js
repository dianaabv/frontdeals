  ...
  onCloseModal = () => {
    ...
    updateDeal768(){
      const formData = `deal768=${JSON.stringify(this.state.deal768)}&deal_id=${this.props.data.deal_id}&duedate=${this.state.duedate}&shelfdate=${this.state.shelfdate}`
        axios.post('https://sdelkibackend.herokuapp.com/update/updateDeal768',formData, {
            responseType: 'json',
            headers: {
                'Content-type': 'application/x-www-form-urlencoded',
                'Authorization': `bearer ${Auth.getToken()}`
    ...
    render() {
                      ...
                      <div className="row">
                       <div className="col-md-6">
                        ...
                        <label className="form-control-label">{this.props.data.bailor.firstname} {this.props.data.bailor.lastname}</label>
                         ...
                         <div className="form-group">
        <h4 className="form-control-label"  >Вещь, передаваемая на хранение</h4>
      ...
      <div className="form-group">
        <h4 className="form-control-label"  >Срок хранения</h4>
      ...
      <div className="form-group">
        <h4 className="form-control-label"  >Вознаграждение и возмещение расходов хранителю </h4>
      ...
      <div className="form-group">
        <h4 className="form-control-label"  >Ответственность за несохранность</h4>
